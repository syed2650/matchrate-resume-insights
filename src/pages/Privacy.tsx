...
export default function Privacy() {
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "Privacy Policy",
    "description": "MatchRate.co Privacy Policy - Learn how we collect, use, and protect your personal information and resume data.",
    "url": "https://www.matchrate.co/privacy",
    "publisher": {
      "@type": "Organization",
      "name": "MatchRate",
  ...
  return (
    <>
      <SEOHead
        title="Privacy Policy - MatchRate Data Protection & Security"
        description="MatchRate.co Privacy Policy - Learn how we collect, use, and protect your personal information and resume data with industry-standard security measures."
        keywords="privacy policy, data protection, resume security, personal information, GDPR compliance, data privacy"
        canonicalUrl="https://www.matchrate.co/privacy"
      ...
      <InternalLinkNav currentPage="privacy" showCallToAction={false} />
    </>
  );
}