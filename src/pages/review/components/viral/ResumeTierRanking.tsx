...
const tiers: Record<string, TierInfo> = {
  elite: {
    ...
    icon: Crown,
    description: "Recruiters will fight over this resume. You're in the elite tier.",
    percentile: "Top 10%",
  ...
  strong: {
    ...
    icon: Star,
    description: "You're competing… but not standing out.",
    percentile: "Top 30%",
  ...
  average: {
    ...
    icon: TrendingUp,
    description: "Your resume looks like everyone else's — and that's the problem.",
