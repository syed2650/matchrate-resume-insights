...
export const ExecutiveSummary = ({
  ...
  const getResumeVerdict = () => {
    ...
    if (resumeScore >= 70) return { label: "Good", color: "bg-emerald-100 text-emerald-700" };
    if (resumeScore >= 45) return { label: "Needs Work", color: "bg-amber-100 text-amber-700" };
  ...
  const getATSVerdict = () => {
    ...
    if (atsVerdict?.toLowerCase().includes("risk") || atsScore < 45) {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        >
          ...
          <h3 className="font-semibold text-foreground mb-1">ATS Compatibility</h3>
        ...
        >
          ...
          <h3 className="font-semibold text-foreground mb-1">Job Match</h3>
      ...
      <div className="bg-gradient-to-br from-orange-50 to-amber-50 rounded-xl p-5 border border-orange-200/50">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-foreground mb-2">🔥 Resume Roast</h3>
            {roastPreview ? (
